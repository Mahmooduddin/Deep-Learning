...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./graphs/ICE6_1', sess.graph)
    ...
    for i in range(1001):
        ...
        #train_step, loss, summary = sess.run([train_step, loss, merged])
        _, summary = sess.run([loss_summary, merged],
